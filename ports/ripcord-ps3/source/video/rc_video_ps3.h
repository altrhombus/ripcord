...
/*
 * The longest the display stayed busy WITHOUT A BREAK. Distinct from the busy count, which cannot tell
 * a stalled GPU from a slow one - see the note where it is measured. Seconds here means the RSX stopped.
 */
